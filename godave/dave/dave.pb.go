...
const (
	Op_GETPEER Op = 0 // Addr gossip pt.1
	Op_PEER    Op = 1 // Addr gossip pt.2
	Op_SETDAT  Op = 2 // Write to the network
	Op_GETDAT  Op = 3 // Read from the network
	Op_DAT     Op = 4 // Something stored in the network
)
...
type Msg struct {
	...
	Time  []byte   `protobuf:"bytes,4,opt,name=time,proto3" json:"time,omitempty"`   // 8B big-endian unix milliseconds
	...
	Tag   []byte   `protobuf:"bytes,8,opt,name=tag,proto3" json:"tag,omitempty"`     // 32B anything
}
...
var file_dave_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x64, 0x61, 0x76, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa6, 0x01, 0x0a,
	...
	0x72, 0x65, 0x76, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x03, 0x74, 0x61, 0x67, 0x2a, 0x3c, 0x0a, 0x02, 0x4f, 0x70, 0x12, 0x0b, 0x0a, 0x07, 0x47,
